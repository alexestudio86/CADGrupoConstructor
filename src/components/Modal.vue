<template>
    <div ref="modal" class="w3-modal w3-black w3-show" style="z-index: 2;">
        ...
        <figure class="w3-display-middle w-100 w3-content">
            <!--<img class="modal-image" :src="images[modalElements.idx.value].source" :alt="images[modalElements.idx].title" />-->
            <button class="w3-button w3-gray w3-display-left">❮</button>
            <button class="w3-button w3-gray w3-display-right" @click="handleNextImage">❯</button>
